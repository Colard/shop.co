...
let NavBar: React.FC<NavLinkProps> = ({ isOpen, links }) => {
  ...
  const linkClassName = tw`w-side-menu relative origin-left cursor-pointer py-3 pl-8 transition-all duration-200 hover:scale-120 hover:transform hover:text-shadow-[1px_0_0_currentColor] lg:w-auto lg:origin-center lg:pl-0`;
