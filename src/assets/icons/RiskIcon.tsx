...
const RiskIcon: React.FC<RiskIconProps> = ({
  className,
  bgColorClass = "text-star-yellow",
  ...props
}) => (
  <svg
    viewBox="0 0 122.88 111.24"
